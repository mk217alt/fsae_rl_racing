...
RACINGLINE_MODEL = f"{THESIS}/Racing/Racing_Line_Variant/car2_racingline_ppo_model.zip"
SELFPLAY_MODEL = f"{THESIS}/checkpoint_backups/car_race_ppo_model_{SELFPLAY_LABEL}.zip"
