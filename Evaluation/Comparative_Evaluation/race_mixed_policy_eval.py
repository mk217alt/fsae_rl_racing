...
import os
import sys
sys.path.insert(0, os.path.join(os.path.dirname(os.path.abspath(__file__)), "..", "Racing/Two_Car_Self_Play_Racing"))
import math
import sys
...
RACINGLINE_MODEL_PATH = "C:/Users/sanja/Desktop/thesis/Racing/Racing_Line_Variant/car2_racingline_ppo_model"
RACE_MODEL_PATH = "C:/Users/sanja/Desktop/thesis/Racing/Two_Car_Self_Play_Racing/car_race_ppo_model"
...
with open(f"C:/Users/sanja/Desktop/thesis/race_mixed_policy_eval_log{OUT_SUFFIX}.txt", "w") as f:
    f.write("\n".join(lines) + "\n")

with open(f"C:/Users/sanja/Desktop/thesis/race_mixed_policy_eval_done{OUT_SUFFIX}.txt", "w") as f:
    f.write("done\n")
