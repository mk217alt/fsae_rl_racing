...
def telemetry_step(step_size):
    ...
    with open("C:/Users/sanja/Desktop/thesis/mixed_race_demo_telemetry.txt", "a") as f:
...
with open("C:/Users/sanja/Desktop/thesis/run_mixed_race_demo_ready.txt", "w") as f:
    f.write("ready\n")
