...
import os
import sys
sys.path.insert(0, os.path.join(os.path.dirname(os.path.abspath(__file__)), "..", "Two_Car_Self_Play_Racing"))
import math
import sys
...
RACINGLINE_MODEL_PATH = "C:/Users/sanja/Desktop/thesis/Racing_Line_Variant/car2_racingline_ppo_model"
RACE_MODEL_PATH = "C:/Users/sanja/Desktop/thesis/Two_Car_Self_Play_Racing/car_race_ppo_model"
