...
LOG_PATH = f"{ROOT}/6_training_logs/car_race_train_monitor.csv"
...
# To revert: copy the desired 3_trained_models/checkpoints/car_race_ppo_model_<label>.zip
...
with open(f"{ROOT}/run_output/train_race_vec_done.txt", "w") as f:
