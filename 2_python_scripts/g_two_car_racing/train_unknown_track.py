...
are preserved in 3_trained_models/checkpoints/, so this is fully reversible.
...
LOG_PATH = f"{ROOT}/6_training_logs/car_unknown_track_train_monitor.csv"
BACKUP_DIR = f"{ROOT}/3_trained_models/checkpoints"
...
with open(f"{ROOT}/run_output/train_unknown_track_done.txt", "w") as f:
