...
RESULTS_PATH = f"{ROOT}/4_results/compare_smoothness_results.txt"

N_EPISODES = 10

CHECKPOINTS = {
    "pre_smoothness": f"{ROOT}/3_trained_models/checkpoints/car2_ppo_model_pre_smoothness",
    "post_smoothness": f"{ROOT}/3_trained_models/car2_ppo_model",
}
