...
OUT_MODEL_PATH = f"{ROOT}/3_trained_models/car2_bc_finetuned_v3"
LOG_PATH = f"{ROOT}/6_training_logs/car2_bc_finetune_v3_monitor.csv"
LEARNING_RATE = 5e-5
...
with open(f"{ROOT}/run_output/finetune_bc_v3_done.txt", "w") as f:
