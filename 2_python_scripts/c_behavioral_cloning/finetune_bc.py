...
BC_MODEL_PATH = f"{ROOT}/3_trained_models/car2_bc_pretrained"
OUT_MODEL_PATH = f"{ROOT}/3_trained_models/car2_bc_finetuned"
LOG_PATH = f"{ROOT}/6_training_logs/car2_bc_finetune_monitor.csv"
...
with open(f"{ROOT}/run_output/finetune_bc_done.txt", "w") as f:
