...
OUT_MODEL_PATH = f"{ROOT}/3_trained_models/car2_bc_warmed"
LOG_PATH = f"{ROOT}/run_output/warmup_critic_log.txt"
...
with open(f"{ROOT}/run_output/warmup_critic_done.txt", "w") as f:
