...
MODEL_PATH = f"{ROOT}/3_trained_models/car2_racingline_ppo_model"
LOG_PATH = f"{ROOT}/6_training_logs/car2_racingline_train_monitor.csv"
...
with open(f"{ROOT}/run_output/train_car2_racingline_done.txt", "w") as f:
